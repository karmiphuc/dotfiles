---
name: tdd
description: Test-driven development with vertical slices. One test → one implementation → repeat. Tests written in bulk test imagined behavior; one test → one implementation tests actual behavior. Use when the user wants to build features or fix bugs test-first, mentions "red-green-refactor", or wants integration tests.
---
